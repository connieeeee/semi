...
public class OrderDto {
	...
	public OrderDto(int buyer_seq, int order_sort, String order_num, int order_count, int order_price, int price_tax,
			int price_sum, String product_name, String product_unit, int product_trade_price, String order_date,
			int order_supply_price, int order_collect_money, int order_not_collect_money, int order_tax_value,
			int order_total, String product_standard, int product_seq) {
		super();
